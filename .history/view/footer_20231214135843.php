<footer class="footer__section bg__black">
        <div class="container-fluid">
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">Bản quyền © 2023 <a class="copyright__content--link" href="index.php"></a> . Đã đăng ký Bản quyền. Thiết kế bởi team Suruchi</p>
