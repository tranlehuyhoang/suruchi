<footer class="footer__section bg__black">
        <div class="container-fluid">
            <div class="main__footer d-flex justify-content-between">
                <div class="footer__widget footer__widget--width">
                    ...
                    <div class="footer__widget--inner">
                        <p class="footer__widget--desc text-ofwhite mb-20">"Chào mừng đến với trang web của chúng tôi. <br>Nơi bạn có thể khám phá và mua sắm những cuốn sách tuyệt vời bằng tiếng Trung.<br>Chúng tôi tự hào mang đến cho bạn không gian đa dạng với nhiều thể loại,<br>từ văn học đến sách giáo trình, để đáp ứng mọi nhu cầu đọc sách của bạn." </p>
            ...
            <div class="footer__bottom d-flex justify-content-between align-items-center">
                <p class="copyright__content text-ofwhite m-0">Bản quyền © 2023 <a class="copyright__content--link" href="index.php">Sách</a> . Đã đăng ký Bản quyền. Thiết kế bởi team Suruchi</p>
