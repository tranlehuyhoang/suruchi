            ...
            <div class="container-fluid">
                <div class="main__header--inner position__relative d-flex justify-content-between align-items-center">
                    ...
                    <div class="main__logo">
                        <h1 class="main__logo--title"><a class="main__logo--link" href="index.php"><img class="main__logo--img" width="150px" src="./view/assets/img/logo/logo.png" alt="logo-img"></a></h1>
                    </div>
                    ...
                    <div class="header__menu d-none header__sticky--block d-lg-block">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items style2">
                                    <a class="header__menu--link" href="#">Thi Hsk </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                    ...
                    <div class="header__menu">
                        <nav class="header__menu--navigation">
                            <ul class="d-flex">
                                ...
                                <li class="header__menu--items">
                                    <a class="header__menu--link" href="index.php?pg=thihsk">Thi Hsk </a>
                                </li>
                            </ul>
                        </nav>
                    </div>
            ...
            <div class="offcanvas__inner">
                ...
                <nav class="offcanvas__menu">
                    <ul class="offcanvas__menu_ul">
                        ...
                        <li class="offcanvas__menu_li"><a class="offcanvas__menu_item" href="index.php?pg=thihsk">THI HSK</a></li>
                    </ul>
